...
function doupdate(){
	...
	document.forms.checkoutform.action='cart.php?mode=login&refurl=%2FLoginRedirect.php';
...
/* ]]> */</script>
	...
	<input type="hidden" name="sessionid" value="nfnmpcqt5oourt0gv9djpluno6" />
	...
	<input type="hidden" name="listid" value="" />
			<table class="cobtbl" width="100%" border="0" cellspacing="1" cellpadding="3">
			  ...
			  <tr>
				...
				<td class="cobll" align="left"><input type="hidden" name="refurl" value="/LoginRedirect.php" />
<input type="password" name="pass" size="20" value="" autocomplete="off" /></td>
			  ...
			  <tr>
				<td class="cobll" align="center" height="26" colspan="2"><input type="submit" value="Submit" onclick="document.forms.checkoutform.action='cart.php';document.forms.checkoutform.mode.value='dologin';" class="cartaccountlogin" />&nbsp;&nbsp;<input type="button" value="New Account" class="newaccount" onclick="document.location=(((ECTbh=document.getElementsByTagName('base')).length>0?ECTbh[0].href+'/':'')+'cart.php?mode=newaccount').replace(/([^:]\/)\/+/g,'$1')" />&nbsp;&nbsp;<input type="button" value="Forgot Password?" class="forgotpassword" onclick="document.location=(((ECTbh=document.getElementsByTagName('base')).length>0?ECTbh[0].href+'/':'')+'clientlogin.php?mode=lostpassword').replace(/([^:]\/)\/+/g,'$1')" /></td>
			  </tr>
	</table>
	</form>
			</div></td>
