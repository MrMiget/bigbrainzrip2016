...
<title>bigbrainz.com - Login</title><SCRIPT LANGUAGE="JavaScript">
<!--
  function squirrelmail_loginpage_onload() {
    document.forms[0].js_autodetect_results.value = '1';
    document.forms[0].elements[0].focus();
  }
  self.regSMEmail = /^[a-zA-Z0-9\-\.\_]+\@bigbrainz.com$/;
  function checkForm(form) {
    ...
    if ((checkusername == null) || (checkusername[0] != username)) {
      alert("You must enter your fully qualified email address, such as username@bigbrainz.com");
      return false;    }
  }
// -->
</script>
